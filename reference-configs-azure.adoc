...
| Capacité système maximale (disques + stockage objet) | 500 Gio | 2 Pio | 2 Tio ^1^ | 10 To | 368 To | 368 Tio par licence 
...
[cols="h,d,d,d,d,d"]
|===
|  | Fréemium | Licence basée sur la capacité | PAIEMENT À L'UTILISATION Standard | PAIEMENT À L'UTILISATION Premium | BYOL basé sur les nœuds 


| Capacité système maximale (disques + stockage objet) | 500 Gio | 2 Pio | 10 To | 368 To | 368 Tio par licence 
