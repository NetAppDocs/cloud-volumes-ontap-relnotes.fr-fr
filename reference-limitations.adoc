...
https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-backup-to-cloud.html["Découvrez comment utiliser les fonctionnalités de sauvegarde et de restauration BlueXP pour sauvegarder et restaurer des données ONTAP"^].
