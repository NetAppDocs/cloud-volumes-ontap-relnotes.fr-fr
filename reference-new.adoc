...
D'autres fonctionnalités et améliorations sont également introduites dans les dernières versions de BlueXP. Voir la https://["Notes de mise à jour BlueXP"^] pour plus d'informations.
